          ...
          <div className="bd-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="bd-help">
              ...
              <p>
                ...
                {' '}{lang === 'fr' ? 'et' : 'and'}{' '}
                <a href="https://birdl.online/" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--copper)', textDecoration: 'underline' }}>BirdL</a>.
              </p>
              {lang === 'fr' && (
                <p style={{
                  marginTop: 18,
